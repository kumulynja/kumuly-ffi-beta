...
class seed_ffi {
  ...
  late final _new1Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<Mnemonic> Function(ffi.Int32, ffi.Int32)>>('new');
  late final _new1 =
      _new1Ptr.asFunction<ffi.Pointer<Mnemonic> Function(int, int)>();
  ...
  /// A pointer to the newly created `Mnemonic`. The caller must ensure that the `Mnemonic`
  /// is properly deallocated to avoid memory leaks.
  ffi.Pointer<Mnemonic> from_phrase(
  ...
  late final _from_phrasePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<Mnemonic> Function(
              ffi.Pointer<ffi.Char>)>>('from_phrase');
  late final _from_phrase = _from_phrasePtr
      .asFunction<ffi.Pointer<Mnemonic> Function(ffi.Pointer<ffi.Char>)>();
  ...
  ffi.Pointer<ffi.Char> derive_lightning_seed(
    ffi.Pointer<Mnemonic> self,
    int network,
    ffi.Pointer<ffi.Uint32> hardened_child_index,
  ) {
    return _derive_lightning_seed(
      self,
      network,
  ...
  late final _derive_lightning_seedPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<Mnemonic>, ffi.Int32,
              ffi.Pointer<ffi.Uint32>)>>('derive_lightning_seed');
  late final _derive_lightning_seed = _derive_lightning_seedPtr.asFunction<
      ffi.Pointer<ffi.Char> Function(
          ffi.Pointer<Mnemonic>, int, ffi.Pointer<ffi.Uint32>)>();
  ...
  void free_mnemonic(
    ffi.Pointer<Mnemonic> mnemonic,
  ) {
    return _free_mnemonic(
      mnemonic,
    );
  }

  late final _free_mnemonicPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<Mnemonic>)>>(
          'free_mnemonic');
  late final _free_mnemonic =
      _free_mnemonicPtr.asFunction<void Function(ffi.Pointer<Mnemonic>)>();
  ...
  ///
  /// This function should only be used to free memory that was allocated by the Rust code.
  void free_lightning_seed(
    ffi.Pointer<ffi.Pointer<ffi.Uint8>> seed,
  ) {
    return _free_lightning_seed(
      seed,
    );
  }

  late final _free_lightning_seedPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>>('free_lightning_seed');
  late final _free_lightning_seed = _free_lightning_seedPtr
...
abstract class WordCount {
  ...
  static const int Words12 = 12;

  /// 15 words mnemonic (160 bits entropy)
  static const int Words15 = 15;

  /// 18 words mnemonic (192 bits entropy)
  static const int Words18 = 18;

  /// 21 words mnemonic (224 bits entropy)
  static const int Words21 = 21;

  /// 24 words mnemonic (256 bits entropy)
  static const int Words24 = 24;
}

final class Mnemonic extends ffi.Struct {
  external ffi.Pointer<ffi.Char> phrase;
