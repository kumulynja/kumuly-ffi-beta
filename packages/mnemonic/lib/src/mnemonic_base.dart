...
import 'package:mnemonic/src/enums/enums.dart';
import 'package:mnemonic/src/enums/language.dart';
import 'package:mnemonic/src/enums/network.dart';
import 'package:mnemonic/src/enums/word_count.dart';
import 'mnemonic_ffi.dart' as bindings; // The file generated by ffigen

class Mnemonic {
  static final _lib =
      ffi.DynamicLibrary.open('../../target/debug/libmnemonic_ffi.dylib');
  static final _bindings = bindings.mnemonic_ffi(_lib);
